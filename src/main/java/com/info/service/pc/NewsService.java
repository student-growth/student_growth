...
import com.info.client.NewsClient;
...
//    private String articlePath;
    ...
    public String getArticleList(int offset,int size) throws Exception{

        return newsClient.getContentList(offset, size);
    }
...
//    public List<ArticleDTO> getNewsList(int size) throws SystemException{
